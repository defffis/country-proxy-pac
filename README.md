...
> Последнее обновление: **2026-09-18T20:08:05Z**
...
| TCP-live кандидатов | 6 313 |
| HTTP проверено | 2 000 |
| HTTPS proxy проверено | 1 065 |
| SOCKS4 проверено | 1 259 |
| SOCKS5 проверено | 1 989 |
| Найден внешний IP | 687 |
| Успешный HTTPS probe | 500 |
| Успешный GeoIP | 500 |
| Рабочих proxy по целевым странам | 189 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 🇹🇷 Турция (`TR`) | 2 | 1 | 0 | 0 | 1 | 1 | 1 | 2 483 ms |
| 🇮🇳 Индия (`IN`) | 22 | 9 | 0 | 10 | 3 | 9 | 13 | 2 787 ms |
| 🇵🇱 Польша (`PL`) | 3 | 0 | 0 | 3 | 0 | 0 | 3 | — |
| 🇳🇱 Нидерланды (`NL`) | 29 | 18 | 0 | 4 | 7 | 18 | 11 | 1 779 ms |
| 🇩🇪 Германия (`DE`) | 24 | 9 | 0 | 7 | 8 | 9 | 15 | 1 848 ms |
| 🇺🇸 США (`US`) | 103 | 25 | 0 | 16 | 62 | 25 | 78 | 301 ms |
| 🇬🇧 Великобритания (`GB`) | 6 | 2 | 1 | 1 | 2 | 3 | 3 | 1 763 ms |
...
> Last update: **2026-09-18T20:08:05Z**

| Metric | Value |
|---|---:|
| Sources | 20 |
| Candidates processed | 20 000 |
| TCP-live candidates | 6 313 |
| Working target-country proxies | 189 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 🇹🇷 Turkey (`TR`) | 2 | 1 | 0 | 0 | 1 | 1 | 1 | 2 483 ms |
| 🇮🇳 India (`IN`) | 22 | 9 | 0 | 10 | 3 | 9 | 13 | 2 787 ms |
| 🇵🇱 Poland (`PL`) | 3 | 0 | 0 | 3 | 0 | 0 | 3 | — |
| 🇳🇱 Netherlands (`NL`) | 29 | 18 | 0 | 4 | 7 | 18 | 11 | 1 779 ms |
| 🇩🇪 Germany (`DE`) | 24 | 9 | 0 | 7 | 8 | 9 | 15 | 1 848 ms |
| 🇺🇸 United States (`US`) | 103 | 25 | 0 | 16 | 62 | 25 | 78 | 301 ms |
| 🇬🇧 United Kingdom (`GB`) | 6 | 2 | 1 | 1 | 2 | 3 | 3 | 1 763 ms |
