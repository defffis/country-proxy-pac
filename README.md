...
> Последнее обновление: **2026-09-15T19:22:29Z**
...
|---|---:|
| Источников | 20 |
| Кандидатов обработано | 18 227 |
| TCP-live кандидатов | 6 044 |
| HTTP проверено | 1 671 |
| HTTPS proxy проверено | 1 035 |
| SOCKS4 проверено | 1 212 |
| SOCKS5 проверено | 2 126 |
| Найден внешний IP | 654 |
| Успешный HTTPS probe | 419 |
| Успешный GeoIP | 419 |
| Рабочих proxy по целевым странам | 157 |
| HTTP/HTTPS endpoints для PAC | 30 |
| SOCKS endpoints для PAC | 127 |
| Максимум кандидатов | 18 227 |
...
| 🇮🇳 Индия (`IN`) | 21 | 3 | 0 | 6 | 12 | 3 | 18 | 2 878 ms |
| 🇵🇱 Польша (`PL`) | 1 | 0 | 0 | 1 | 0 | 0 | 1 | — |
| 🇳🇱 Нидерланды (`NL`) | 22 | 8 | 0 | 4 | 10 | 8 | 14 | 2 095 ms |
| 🇩🇪 Германия (`DE`) | 8 | 1 | 0 | 1 | 6 | 1 | 7 | 5 467 ms |
| 🇺🇸 США (`US`) | 98 | 16 | 0 | 12 | 70 | 16 | 82 | 510 ms |
| 🇬🇧 Великобритания (`GB`) | 7 | 1 | 1 | 0 | 5 | 2 | 5 | 1 524 ms |
...
| `germany.pac` | 1 | [`germany.pac`](https://raw.githubusercontent.com/defffis/country-proxy-pac/main/pac/germany.pac) |
...
| `usa-socks.pac` | 82 | [`usa-socks.pac`](https://raw.githubusercontent.com/defffis/country-proxy-pac/main/pac/usa-socks.pac) |
...
> Last update: **2026-09-15T19:22:29Z**

| Metric | Value |
|---|---:|
| Sources | 20 |
| Candidates processed | 18 227 |
| TCP-live candidates | 6 044 |
...
| 🇮🇳 India (`IN`) | 21 | 3 | 0 | 6 | 12 | 3 | 18 | 2 878 ms |
| 🇵🇱 Poland (`PL`) | 1 | 0 | 0 | 1 | 0 | 0 | 1 | — |
| 🇳🇱 Netherlands (`NL`) | 22 | 8 | 0 | 4 | 10 | 8 | 14 | 2 095 ms |
| 🇩🇪 Germany (`DE`) | 8 | 1 | 0 | 1 | 6 | 1 | 7 | 5 467 ms |
| 🇺🇸 United States (`US`) | 98 | 16 | 0 | 12 | 70 | 16 | 82 | 510 ms |
| 🇬🇧 United Kingdom (`GB`) | 7 | 1 | 1 | 0 | 5 | 2 | 5 | 1 524 ms |
