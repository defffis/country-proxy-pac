...
> Последнее обновление: **2026-09-06T21:50:03Z**
...
|---|---:|
| Источников | 20 |
| Кандидатов обработано | 12 017 |
| TCP-live кандидатов | 5 376 |
| HTTP проверено | 1 708 |
| HTTPS proxy проверено | 1 126 |
| SOCKS4 проверено | 1 347 |
| SOCKS5 проверено | 1 195 |
| Найден внешний IP | 558 |
| Успешный HTTPS probe | 406 |
| Успешный GeoIP | 406 |
| Рабочих proxy по целевым странам | 105 |
| HTTP/HTTPS endpoints для PAC | 65 |
| SOCKS endpoints для PAC | 40 |
| Максимум кандидатов | 12 017 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 🇹🇷 Турция (`TR`) | 2 | 2 | 0 | 0 | 0 | 2 | 0 | 6 573 ms |
| 🇮🇳 Индия (`IN`) | 20 | 17 | 0 | 2 | 1 | 17 | 3 | 2 741 ms |
| 🇵🇱 Польша (`PL`) | 5 | 5 | 0 | 0 | 0 | 5 | 0 | 2 886 ms |
| 🇳🇱 Нидерланды (`NL`) | 20 | 7 | 0 | 2 | 11 | 7 | 13 | 1 774 ms |
| 🇩🇪 Германия (`DE`) | 10 | 7 | 0 | 0 | 3 | 7 | 3 | 1 813 ms |
| 🇺🇸 США (`US`) | 46 | 26 | 0 | 8 | 12 | 26 | 20 | 552 ms |
| 🇬🇧 Великобритания (`GB`) | 2 | 1 | 0 | 0 | 1 | 1 | 1 | 1 820 ms |
...
| `poland.pac` | 5 | [`poland.pac`](https://raw.githubusercontent.com/defffis/country-proxy-pac/main/pac/poland.pac) |
...
> Last update: **2026-09-06T21:50:03Z**

| Metric | Value |
|---|---:|
| Sources | 20 |
| Candidates processed | 12 017 |
| TCP-live candidates | 5 376 |
| Working target-country proxies | 105 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 🇹🇷 Turkey (`TR`) | 2 | 2 | 0 | 0 | 0 | 2 | 0 | 6 573 ms |
| 🇮🇳 India (`IN`) | 20 | 17 | 0 | 2 | 1 | 17 | 3 | 2 741 ms |
| 🇵🇱 Poland (`PL`) | 5 | 5 | 0 | 0 | 0 | 5 | 0 | 2 886 ms |
| 🇳🇱 Netherlands (`NL`) | 20 | 7 | 0 | 2 | 11 | 7 | 13 | 1 774 ms |
| 🇩🇪 Germany (`DE`) | 10 | 7 | 0 | 0 | 3 | 7 | 3 | 1 813 ms |
| 🇺🇸 United States (`US`) | 46 | 26 | 0 | 8 | 12 | 26 | 20 | 552 ms |
| 🇬🇧 United Kingdom (`GB`) | 2 | 1 | 0 | 0 | 1 | 1 | 1 | 1 820 ms |
