...
> Последнее обновление: **2026-09-19T13:34:16Z**
...
| TCP-live кандидатов | 6 876 |
| HTTP проверено | 2 693 |
| HTTPS proxy проверено | 1 131 |
| SOCKS4 проверено | 1 225 |
| SOCKS5 проверено | 1 827 |
| Найден внешний IP | 688 |
| Успешный HTTPS probe | 485 |
| Успешный GeoIP | 485 |
| Рабочих proxy по целевым странам | 180 |
| HTTP/HTTPS endpoints для PAC | 58 |
| SOCKS endpoints для PAC | 122 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 🇹🇷 Турция (`TR`) | 3 | 2 | 0 | 1 | 0 | 2 | 1 | 1 963 ms |
| 🇮🇳 Индия (`IN`) | 16 | 13 | 0 | 1 | 2 | 13 | 3 | 2 532 ms |
| 🇵🇱 Польша (`PL`) | 2 | 0 | 0 | 1 | 1 | 0 | 2 | — |
| 🇳🇱 Нидерланды (`NL`) | 39 | 21 | 0 | 6 | 12 | 21 | 18 | 1 269 ms |
| 🇩🇪 Германия (`DE`) | 19 | 4 | 0 | 6 | 9 | 4 | 15 | 1 354 ms |
| 🇺🇸 США (`US`) | 91 | 16 | 0 | 12 | 63 | 16 | 75 | 449 ms |
| 🇬🇧 Великобритания (`GB`) | 10 | 1 | 1 | 1 | 7 | 2 | 8 | 1 255 ms |
...
| `usa-socks.pac` | 75 | [`usa-socks.pac`](https://raw.githubusercontent.com/defffis/country-proxy-pac/main/pac/usa-socks.pac) |
...
> Last update: **2026-09-19T13:34:16Z**

| Metric | Value |
|---|---:|
| Sources | 20 |
| Candidates processed | 20 000 |
| TCP-live candidates | 6 876 |
| Working target-country proxies | 180 |
| HTTP/HTTPS PAC endpoints | 58 |
| SOCKS PAC endpoints | 122 |

| Country | Working | HTTP | HTTPS | SOCKS4 | SOCKS5 | PAC HTTP/HTTPS | PAC SOCKS | Best latency |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 🇹🇷 Turkey (`TR`) | 3 | 2 | 0 | 1 | 0 | 2 | 1 | 1 963 ms |
| 🇮🇳 India (`IN`) | 16 | 13 | 0 | 1 | 2 | 13 | 3 | 2 532 ms |
| 🇵🇱 Poland (`PL`) | 2 | 0 | 0 | 1 | 1 | 0 | 2 | — |
| 🇳🇱 Netherlands (`NL`) | 39 | 21 | 0 | 6 | 12 | 21 | 18 | 1 269 ms |
| 🇩🇪 Germany (`DE`) | 19 | 4 | 0 | 6 | 9 | 4 | 15 | 1 354 ms |
| 🇺🇸 United States (`US`) | 91 | 16 | 0 | 12 | 63 | 16 | 75 | 449 ms |
| 🇬🇧 United Kingdom (`GB`) | 10 | 1 | 1 | 1 | 7 | 2 | 8 | 1 255 ms |
